...
def parse_arguments():
  ...
  #  parser.add_argument('--census_version', type=str, default='2024-07-01', help='Census version (e.g., 2024-07-01)')
    ...
    parser.add_argument('--cutoff', type=str, default=0, help="Cutoff probability for classification, else cell will be assigned unknown")
...
def main():
    ...
    query.obs["cell_type"] = rfc.predict(query.obsm["scvi"])
